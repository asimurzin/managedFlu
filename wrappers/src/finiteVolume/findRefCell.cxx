...
%inline
{
  ...
  Foam::t_setRefCell ext_setRefCell( const Foam::volScalarFieldHolder& field,
...
//----------------------------------
  ...
  Foam::t_setRefCell ext_setRefCell( const Foam::volScalarFieldHolder& field,
                                     const Foam::volScalarFieldHolder& fieldRef,
                                     const Foam::dictionary& dict,
                                     Foam::label refCelli,
                                     Foam::scalar refValue,
                                     const bool forceReference=false )
...
//---------------------------------------------------------------------------
#if  FOAM_VERSION( >=, 010600 ) || FOAM_BRANCH_VERSION( __OPENFOAM_EXT__, >=, 010500 )
  Foam::scalar getRefCellValue( const Foam::volScalarFieldHolder& field, const Foam::label refCelli );
#endif
