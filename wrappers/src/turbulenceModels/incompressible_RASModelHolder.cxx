...
//---------------------------------------------------------------------------
#ifndef incompressible_RASModelHolder_cxx
#define incompressible_RASModelHolder_cxx


//---------------------------------------------------------------------------
%module "wrappers.src.turbulenceModels.incompressible_RASModelHolder"

%{
  #include "wrappers/src/turbulenceModels/incompressible_RASModelHolder.hh"
%}


//---------------------------------------------------------------------------
%import "wrappers/src/shared_ptr/shared_ptr_incompressible_RASModel.cxx"

%import "wrappers/src/DependentHolder.cxx"

%import "wrappers/src/OpenFOAM/GeometricFieldHolders.cxx"

%import "wrappers/src/turbulenceModels/incompressible_turbulenceModelHolder.cxx"
