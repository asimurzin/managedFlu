...
//---------------------------------------------------------------------------
#ifndef fvmLaplacian_010701_free_hpp
#define fvmLaplacian_010701_free_hpp
...
namespace Foam
{
  namespace fvm
  {
    ...
    template< class Type, class GType >
    inline fvMatrixHolder< Type > laplacian( const GeometricFieldHolder< GType, fvsPatchField, surfaceMesh >& field1, 
					     GeometricFieldHolder< Type, fvPatchField, volMesh >& field2 )
    {
      return fvMatrixHolder< Type >( laplacian( field1(), field2() ), Deps( &field1, &field2 )  );
    }
